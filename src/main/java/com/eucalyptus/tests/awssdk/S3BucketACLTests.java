...
public class S3BucketACLTests {
  ...
  public static void init() throws Exception {
    print("### PRE SUITE SETUP - " + S3BucketACLTests.class.getSimpleName());
    try {
      account = S3BucketACLTests.class.getSimpleName().toLowerCase();
  ...
  public static void teardown() throws Exception {
    print("### POST SUITE CLEANUP - " + S3BucketACLTests.class.getSimpleName());
  ...
  public void createBucket_ACL_Headers() throws Exception {
    ...
    try {
      ...
      acl.getGrantsAsList().add(new Grant(GroupGrantee.AuthenticatedUsers, Permission.ReadAcp));
      ...
      acl.getGrantsAsList().add(new Grant(GroupGrantee.AllUsers, Permission.FullControl));
      acl.getGrantsAsList().add(new Grant(new CanonicalGrantee(ownerId), Permission.FullControl));
  ...
  public void setBucket_ACL_XMLBody() throws Exception {
    ...
    try {
      ...
      acl.getGrantsAsList().add(new Grant(GroupGrantee.AllUsers, Permission.WriteAcp));
      acl.getGrantsAsList().add(new Grant(new CanonicalGrantee(ownerId), Permission.FullControl));
