...
//  }
  ...
  void testLargePolicy( ) {
    ...
    String largePolicy = """{"Version":"2012-10-17","Statement":[{"Sid": "${'a'*16000}", "Effect":"Allow","Principal":{"AWS":"${requestorAccountNumber}"},"Action":"s3:GetObject","Resource":"arn:aws:s3:::${bucketName}/foo"}]}"""
    s3.with {
