...
public class TestSQSDeleteMessage {
  ...
  public static void init() throws Exception {
    print("### PRE SUITE SETUP - " + TestSQSDeleteMessage.class.getSimpleName());

    try {
      getCloudInfoAndSqs();
      account = "sqs-account-dm-a-" + System.currentTimeMillis();
      synchronizedCreateAccount(account);
      accountSQSClient = getSqsClientWithNewAccount(account, "admin");
      otherAccount = "sqs-account-dm-b-" + System.currentTimeMillis();
  ...
  public static void teardown() {
    print("### POST SUITE CLEANUP - " + TestSQSDeleteMessage.class.getSimpleName());
    if (account != null) {
