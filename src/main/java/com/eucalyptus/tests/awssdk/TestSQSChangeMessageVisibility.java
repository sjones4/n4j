...
public class TestSQSChangeMessageVisibility {
  ...
  public static void init() throws Exception {
    print("### PRE SUITE SETUP - " + TestSQSChangeMessageVisibility.class.getSimpleName());

    try {
      getCloudInfoAndSqs();
      MAX_VISIBILITY_TIMEOUT = getLocalConfigInt("MAX_VISIBILITY_TIMEOUT");
      account = "sqs-account-cmv-a-" + System.currentTimeMillis();
      synchronizedCreateAccount(account);
      accountSQSClient = getSqsClientWithNewAccount(account, "admin");
      otherAccount = "sqs-account-cmv-b-" + System.currentTimeMillis();
  ...
  public static void teardown() {
    print("### POST SUITE CLEANUP - " + TestSQSChangeMessageVisibility.class.getSimpleName());
    if (account != null) {
